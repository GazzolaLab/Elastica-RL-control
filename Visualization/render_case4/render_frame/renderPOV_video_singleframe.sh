...
#    povray -H2160 -W3840 Quality=11 Antialias=on $filenameOnly
 	# povray -H1080 -W1920 Quality=11 Antialias=on $filenameOnly Output_File_Name=../example_frame.png
 	povray -H540 -W960 Quality=11 Antialias=on $filenameOnly Output_File_Name=../example_frame.png
	# povray -H250 -W400 Quality=11 Antialias=on $filenameOnly Verbose=Off Output_File_Name=../example_frame.png
