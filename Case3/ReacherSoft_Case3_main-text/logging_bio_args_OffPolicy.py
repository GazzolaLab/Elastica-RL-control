...
parser.add_argument(
    "--n_elem", type=int, default=50,
)

parser.add_argument(
    "--sim_dt", type=float, default=1e-4,
)
...
args.num_steps_per_update = int(round(1.4e-3 / args.sim_dt))  # 14
print("Number of updates per step:", args.num_steps_per_update)
...
if args.TRAIN:
    ...
    # model.save("basis_arm_trpo_logging_mus_untrained")
