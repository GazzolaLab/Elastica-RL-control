...
Case 3 main text in CoRL 2020 paper."""
import os
import numpy as np
import sys
...
algo_list = ["PPO", "TRPO", "SAC", "TD3", "DDPG"]
seed_list = [0, 1, 2, 3, 4]
batchsize_list = [16000, 16000, 5000000, 5000000, 5000000]
training_length = 500000
tau = 0.005

algo_list = ["SAC", "TD3", "DDPG"]
batchsize_list = [5000000, 5000000, 5000000]

for alg, algo_name in enumerate(algo_list):
    # for batch in batchsize_list:
    for seed in seed_list:
        args.algo_name = algo_name
        args.SEED = seed
        args.timesteps_per_batch = batchsize_list[alg]
        print()
        video_name = (
            str(args.algo_name)
            + "-128-"
        ...
        # target position
        args.target_position = [-0.8, 0.5, 0.15]
