        ...
        with plt.style.context("seaborn-whitegrid"):
            for time_idx in tqdm(range(0, sim_time.shape[0], int(step))):
                ...
                for rod_idx in range(n_visualized_rods):
                    ...
                    rod_directors1[rod_idx].set_3d_properties(
                        np.array([tip_position[1], tip_position[1] + dir1[1]]).flatten()
                    )
                    ...
                    rod_directors2[rod_idx].set_3d_properties(
                        np.array([tip_position[1], tip_position[1] + dir2[1]]).flatten()
                    )
                    ...
                    rod_directors3[rod_idx].set_3d_properties(
                        np.array([tip_position[1], tip_position[1] + dir3[1]]).flatten()
                    )
                ...
                for sphere_idx in range(n_visualized_spheres):
                    ...
                    sphere_directors1[sphere_idx].set_xdata(
                        np.array(
                            [sphere_position[2], sphere_position[2] + dir1[2]]
                        ).flatten()
                    )
                    ...
                    sphere_directors1[sphere_idx].set_3d_properties(
                        np.array(
                    ...
                    sphere_directors2[sphere_idx].set_xdata(
                        np.array(
                            [sphere_position[2], sphere_position[2] + dir2[2]]
                        ).flatten()
                    )
                    ...
                    sphere_directors2[sphere_idx].set_3d_properties(
                        np.array(
                    ...
                    sphere_directors3[sphere_idx].set_xdata(
                        np.array(
                            [sphere_position[2], sphere_position[2] + dir3[2]]
                        ).flatten()
                    )
                    ...
                    sphere_directors3[sphere_idx].set_3d_properties(
                        np.array(
